document.addEventListener('DOMContentLoaded', function () {
    ...
    utils.registerToolActions('compassionate-response', () => currentResult, {
        getFilenameFn: () => {
            const systemPromptKey = document.getElementById('systemPrompt').value || 'response';
            return `compassionate_response_${systemPromptKey}`;
        }
    });
        ...
        try {
            ...
            document.getElementById('resultContent').innerHTML = `
                <div class="result-display">
                    ${htmlContent}
                    <div style="text-align: right; opacity: 0.7; font-size: 0.9rem; margin-top: 15px;">
